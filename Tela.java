...
/**
 * Classe responsï¿½vel por criar interface do jogo, controlar os movimentos do teclado e a leitura da fase.
 */
public class Tela extends JFrame implements ActionListener {
    ...
    /**
     * Constrï¿½i toda a interface do Jogo.
     */
    public Tela() {
        ...
        ButtonLoad.addActionListener(new ActionListener() {       
            /**
             * Le Arquivo passado pelo usuï¿½rio apï¿½s clique no Botï¿½o Carrega.
             */            
            public void actionPerformed(ActionEvent a) {
                try {
    ...
    /**
     * Pinta na Tela todos as informaï¿½ï¿½es do jogo.
     */                    
     ...
     * Acho que ï¿½ aqui o problema das "piscadas", porque ele redesenha TUDO.
     */            
    public void repinta() {
    ...
    /**
     * Espera por um numero especï¿½fico de milisegundos antes de finalizar.
     */
